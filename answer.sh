...
# 12. `LinuxCommandPractice`ディレクトリ内から**移動せずに**、`acti./prce_dir_1/practice_dir_2`ディレクトリ内に`practice_file1.txt`、`practice_file2.txt`というファイルを**一回のコマンドで**作成してください。**但し、相対パスを使用してください。**
